...
module.exports.run = (client, message, args) => {
    ...
    if(type == 1) {
        ...
        const insulte_ran = randomInt(0, insulte.length - 1);
        const personne_ran = randomInt(0, personne.length -1);
        const ordre_ou_exclamation_ran = randomInt(0, ordre_ou_exclamation.length - 1);
        ...
        const phrase_ran = randomInt(0, phrase.length - 1);
